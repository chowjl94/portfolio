    ...
    return (
        <>
            ...
            <motion.p
                ...
                Below are the various projects that I have worked on myself ,
                they are examples of my work and each project is briefly
                described below. Feel free to explore the websites that, and
                allow me to showcase how i solve problems and build projects
